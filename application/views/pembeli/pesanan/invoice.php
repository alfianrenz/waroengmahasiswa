                    ...
                    <div class="card">
                                    ...
                                    <div class="col-sm-12">
                                        <table class="table table-responsive invoice-table table-borderless p-l-20">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Wareong Mahasiswa Universitas CIC</td>
                                                </tr>
                                                <tr>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <h6>Keterangan :</h6>
                                    <p>Invoice ini digunakan sebagai barang bukti kepada penjual ataupun pihak waroeng mahasiswa setelah melakukan pemesanan. Kami juga mengirimkan invoice ini ke email anda agar lebih memudahkan melihat invoice.
                                    </p>
                                </div>
                            </div>
                        </div>
