                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="<?= base_url('upload/foto_user/' . $penjual['foto_mahasiswa']); ?>" alt="" class="img-fluid rounded-circle mt-3" width="150px" style="object-fit: cover;">
                                <h5 class="mb-2 mt-4"><?= $penjual['nama_mahasiswa']; ?></h5>
                                <p><?= $penjual['nim']; ?></p>
                                <a href="" class="btn btn-sm btn-success text-white mb-0">Chat Penjual</a>
                            </div>
